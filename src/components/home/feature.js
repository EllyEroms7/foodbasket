...
export default function Feature() {
  ...
  useEffect(() => {
    ...
    const batch = ScrollTrigger.batch('.fadeAnimation', {
      start: 'top center',
      end:'bottom center',
      scrub: true,
      onEnter: batch => { //animates on enter from top to bottom
        gsap.fromTo(batch, {
          opacity: 0,
          yPercent: 16,
          scale:0.9,
    ...
    return () => {
      ScrollTrigger.batch('.fadeAnimation', {}).forEach(trigger => trigger.kill());
    };
  }, []);
  ...
  return (
    <div id="feature">
        <div className="">
            ...
            <div className='cake rounded-[20px] text-white fadeAnimation opacity-0'>
                <div className='cakeText p-[3rem]'>
                  <h1>Unique Taste</h1>
                  <p>We are passionate about crafting unique tastes that will leave you wanting more.</p>
                  <p>From rich flavours to perfect pairings, we have the perfect treat for every occasion.</p>
                </div>
              </div>

              <div className='design rounded-[20px] text-white m-[24px] fadeAnimation opacity-0'>
              ...
              <div className='quality rounded-[20px] text-white fadeAnimation opacity-0'>
              ...
              <div className='pastry rounded-[20px] text-white m-[24px] fadeAnimation opacity-0'>
              ...
              <div className='ingredient rounded-[20px] text-white m-[24px] fadeAnimation opacity-0'>
                <div className='ingredientText p-[3rem]'>
                        ...
                        <p>We are dedicated to sourcing only the finest ingredients, from the softest doughs, to create truly exceptional baked goods that exceed your expectations.</p>
                  </div>
              </div>

              <div className='help rounded-[20px] text-white fadeAnimation opacity-0'>
              ...
              <div className='health rounded-[20px] text-white m-[24px] fadeAnimation opacity-0'>
                <div className='healthText p-[3rem] '>
                    ...
                    <p>We are committed to crafting baked goods that not only impress your taste buds but also nourish your body.</p>
                      <p>From wholesome ingredients to carefully balanced recipes, we are dedicated to helping you make healthy choices that benefit your wellbeing, so you can savour every moment with confidence.</p>
                  </div>
              </div>
